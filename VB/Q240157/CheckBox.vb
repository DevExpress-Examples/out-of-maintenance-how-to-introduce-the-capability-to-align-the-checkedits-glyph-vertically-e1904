...
Namespace DXSample.Editors
	...
	Public Class MyFlatCheckObjectPainter
		...
		Public Overrides Function CalcObjectBounds(ByVal e As ObjectInfoArgs) As Rectangle
		...
		Protected Overrides Function CanDrawCaption(ByVal e As BaseCheckObjectInfoArgs) As Boolean
			Dim ee As MyCheckObjectInfoArgs = TryCast(e, MyCheckObjectInfoArgs)
		...
		Private Function CalcCaptionSize(ByVal e As CheckObjectInfoArgs, ByVal width As Integer) As Size Implements ICaptionCalculationMethodsProvider.CalcCaptionSize
			Return CalcCaptionSize(e, width)
		End Function

		Private Function CalcCaptionRect(ByVal e As BaseCheckObjectInfoArgs, ByVal bounds As Rectangle, ByVal caption As Rectangle, ByVal glyph As Rectangle) As Rectangle Implements ICaptionCalculationMethodsProvider.CalcCaptionRect
			Return CalcCaptionRect(e, bounds, caption, glyph)
		End Function

		Private Sub CalcHtmlCaptionBounds(ByVal e As CheckObjectInfoArgs) Implements ICaptionCalculationMethodsProvider.CalcHtmlCaptionBounds
	...
	Public Class MyCheckEditViewInfo
		...
		Protected Overrides Sub UpdateCheckProperties(ByVal e As BaseCheckObjectInfoArgs)
		...
		Protected Overrides Function CreateCheckArgs() As BaseCheckObjectInfoArgs
	...
	Public Interface ICaptionCalculationMethodsProvider
		Function CalcCaptionSize(ByVal e As CheckObjectInfoArgs, ByVal width As Integer) As Size
		Function CalcCaptionRect(ByVal e As BaseCheckObjectInfoArgs, ByVal bounds As Rectangle, ByVal caption As Rectangle, ByVal glyph As Rectangle) As Rectangle
		Sub CalcHtmlCaptionBounds(ByVal e As CheckObjectInfoArgs)
	End Interface
End Namespace